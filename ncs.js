          ...
          case "skip":
            {
              if (!channel) {
                ...
                return send(
                  interaction,
                  `${client.config.emoji.SUCCESS}  Song **Skiped**`
                );
              }
            }
            break;
          ...
          case "pauseresume":
            {
              if (!channel) {
                ...
                return send(
                  interaction,
                  ` ${client.config.emoji.SUCCESS} Song **Resumed**`
                );
              } else if (!queue.paused) {
                await queue.pause();
                return send(
          ...
          case "loop":
            {
              if (!channel) {
                ...
                return send(
                  interaction,
                  `${client.config.emoji.SUCCESS} Song Loop is **Enabled**`
                );
                ...
                return send(
                  interaction,
                  ` ${client.config.emoji.SUCCESS} Song Loop is **Disabled**`
                );
              }
            }
            break;
